...
class CommunicationEntries(VapiInterface):
    ...
    def delete(self,
        ...
        """
        Delete CommunicationEntry This API is deprecated. Please use the
    ...
    def get(self,
        ...
        """
        Read CommunicationEntry This API is deprecated. Please use the
    ...
    def list(self,
        ...
        """
        List CommunicationEntries This API is deprecated. Please use the
        following API instead. GET
