...
#
# vAPI stub file for package com.vmware.nsx.pbr.sections.
#---------------------------------------------------------------------------
...
class Rules(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx.pbr.sections.rules'
    """
    ...
    def create(self,
        ...
        :type  p_br_rule: :class:`com.vmware.nsx.model_client.PBRRule`
        :param p_br_rule: (required)
        ...
        :rtype: :class:`com.vmware.nsx.model_client.PBRRule`
        :return: com.vmware.nsx.model.PBRRule
    ...
    def createmultiple(self,
        ...
        """
        Create multiple PBR rules in existing PBR section bounded by limit of
        1000 PBR rules per section.

        :type  section_id: :class:`str`
        :param section_id: (required)
        :type  p_br_rule_list: :class:`com.vmware.nsx.model_client.PBRRuleList`
        :param p_br_rule_list: (required)
        :type  id: :class:`str` or ``None``
        :param id: Identifier of the anchor rule or section. This is a required field
            in case operation like 'insert_before' and 'insert_after'.
            (optional)
        :type  operation: :class:`str` or ``None``
        :param operation: Operation (optional, default to insert_top)
        :rtype: :class:`com.vmware.nsx.model_client.PBRRuleList`
        :return: com.vmware.nsx.model.PBRRuleList
        :raise: :class:`com.vmware.vapi.std.errors_client.ServiceUnavailable` 
             Service Unavailable
        :raise: :class:`com.vmware.vapi.std.errors_client.InvalidRequest` 
             Bad Request, Precondition Failed
    ...
    def list(self,
        ...
        :param sources: Sources referenced by this section's Distributed Service Rules .
            (optional)
        :rtype: :class:`com.vmware.nsx.model_client.PBRRuleListResult`
        :return: com.vmware.nsx.model.PBRRuleListResult
        :raise: :class:`com.vmware.vapi.std.errors_client.ServiceUnavailable` 
             Service Unavailable
        :raise: :class:`com.vmware.vapi.std.errors_client.InvalidRequest` 
             Bad Request, Precondition Failed
    ...
    def revise(self,
        ...
        """
        Modifies existing PBR rule along with relative position among other PBR
        rules inside a PBR section.
...
class _RulesStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        create_input_type = type.StructType('operation-input', {
            ...
            'p_BR_rule': type.ReferenceType('com.vmware.nsx.model_client', 'PBRRule'),
        ...
        create_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/api/v1/pbr/sections/{section-id}/rules',
            request_body_parameter='p_BR_rule',
            path_variables={
        ...
        createmultiple_input_type = type.StructType('operation-input', {
            'section_id': type.StringType(),
            'p_BR_rule_list': type.ReferenceType('com.vmware.nsx.model_client', 'PBRRuleList'),
            'id': type.OptionalType(type.StringType()),
            'operation': type.OptionalType(type.StringType()),
        })
        ...
        createmultiple_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/api/v1/pbr/sections/{section-id}/rules?action=create_multiple',
            request_body_parameter='p_BR_rule_list',
            path_variables={
                'section_id': 'section-id',
            },
            query_parameters={
        ...
        delete_rest_metadata = OperationRestMetadata(
            http_method='DELETE',
            url_template='/api/v1/pbr/sections/{section-id}/rules/{rule-id}',
            path_variables={
                'section_id': 'section-id',
                'rule_id': 'rule-id',
            },
        ...
        revise_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/api/v1/pbr/sections/{section-id}/rules/{rule-id}?action=revise',
            request_body_parameter='p_BR_rule',
            path_variables={
                'section_id': 'section-id',
                'rule_id': 'rule-id',
        ...
        operations = {
            'create': {
                ...
                'output_type': type.ReferenceType('com.vmware.nsx.model_client', 'PBRRule'),
            ...
            'createmultiple': {
                ...
                'output_type': type.ReferenceType('com.vmware.nsx.model_client', 'PBRRuleList'),
            ...
            'list': {
                ...
                'output_type': type.ReferenceType('com.vmware.nsx.model_client', 'PBRRuleListResult'),
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx.pbr.sections.rules',
...
class StubFactory(StubFactoryBase):
    _attrs = {
        'Rules': Rules,
        'rules': 'com.vmware.nsx.pbr.sections.rules_client.StubFactory',
    }
