...
class ClientCertificate(VapiInterface):
    ...
    client certificate. This class was added in vSphere API 7.0.0.
    """
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :param certificate: Public certificate. This attribute was added in vSphere API 7.0.0.
            """
    ...
    def update_task(self,
        ...
        been provisioned.. This method was added in vSphere API 7.0.0.
...
class TrustedPeerCertificates(VapiInterface):
    ...
    def update_task(self,
        ...
        certificate has been set.. This method was added in vSphere API 7.0.0.
