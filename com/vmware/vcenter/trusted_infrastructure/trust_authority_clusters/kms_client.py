...
class Providers(VapiInterface):
    ...
    class Health(Enum):
        ...
        class attribute was added in vSphere API 7.0.0.
    ...
    class ServerInfo(VapiStruct):
        ...
        status of a key server. This class was added in vSphere API 7.0.0.
        ...
        def __init__(self,
            ...
            :param server_trust_client: Whether the server trusts this client. This attribute was added in
                vSphere API 7.0.0.
            :type  name: :class:`str`
            :param name: Name of the server. This attribute was added in vSphere API 7.0.0.
            """
            self.health = health
    ...
    class Status(VapiStruct):
        ...
        of the Key Provider. This class was added in vSphere API 7.0.0.
    ...
    class Server(VapiStruct):
        ...
        connection endpoint. This class was added in vSphere API 7.0.0.
    ...
    class KmipServerCreateSpec(VapiStruct):
        ...
        configuration. This class was added in vSphere API 7.0.0.
        ...
        def __init__(self,
            ...
            :param servers: List of Key Management Interoperability Protocol (KMIP) compliant
                ...
                used.. This attribute was added in vSphere API 7.0.0.
    ...
    class KeyServerCreateSpec(VapiStruct):
        ...
        class Type(Enum):
            ...
            types. This enumeration was added in vSphere API 7.0.0.
    ...
    class Info(VapiStruct):
        ...
        configuration of a provider. This class was added in vSphere API 7.0.0.
...
class ServiceStatus(VapiInterface):
    ...
    Service health status. This class was added in vSphere API 7.0.0.
    """
