...
class Associations(VapiInterface):
    ...
    class LastIterationStatus(Enum):
        ...
        expected.. This enumeration was added in vSphere API 7.0.0.
        ...
        least 1 result.. This class attribute was added in vSphere API 7.0.0.
        ...
        the iterator. This class attribute was added in vSphere API 7.0.0.
    ...
    class IterationSpec(VapiStruct):
        ...
        :func:`Associations.list`). This class was added in vSphere API 7.0.0.
