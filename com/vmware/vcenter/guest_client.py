...
class HostnameGenerator(VapiStruct):
    ...
    class Type(Enum):
        ...
        Generators. This enumeration was added in vSphere API 7.0.0.
        ...
        virtual machine. This class attribute was added in vSphere API 7.0.0.
...
class UserData(VapiStruct):
    ...
    def __init__(self,
        ...
        :param computer_name: The computer name of the (Windows) virtual machine. A computer name
            ...
            options. This attribute was added in vSphere API 7.0.0.
...
class GuiUnattended(VapiStruct):
    ...
    def __init__(self,
        ...
        :param password: The new administrator password for the machine. To specify that the
            ...
            unset. This attribute was added in vSphere API 7.0.0.
...
class WindowsConfiguration(VapiStruct):
    ...
    windows guest operating system. This class was added in vSphere API 7.0.0.
    ...
    def __init__(self,
        ...
        :param reboot: A value specifying the action that should be taken after
            customization. This attribute was added in vSphere API 7.0.0.
...
class LinuxConfiguration(VapiStruct):
    ...
    identifies a Windows machine.. This class was added in vSphere API 7.0.0.
    ...
    def __init__(self,
        ...
        :param script_text: The script to run before and after Linux guest customization.
            ...
            post-customization task code details in the corresponding block. 
             ...
             fi``. This attribute was added in vSphere API 7.0.0.
...
class ConfigurationSpec(VapiStruct):
    ...
    guest operating system. This class was added in vSphere API 7.0.0.
...
class GlobalDNSSettings(VapiStruct):
    ...
    def __init__(self,
        ...
        :param dns_servers: List of DNS servers, for a virtual network adapter with a static IP
            ...
            preference. This attribute was added in vSphere API 7.0.0.
...
class Ipv4(VapiStruct):
    ...
    virtual network adapter. This class was added in vSphere API 7.0.0.
    ...
    def __init__(self,
        ...
        :param prefix: The IPv4 CIDR prefix, for example, 24. See
            ...
            conversion. This attribute was added in vSphere API 7.0.0.
            This attribute is optional and it is only relevant when the value
            of ``type`` is :attr:`Ipv4.Type.STATIC`.
    ...
    class Type(Enum):
        ...
        a virtual machine. This class attribute was added in vSphere API 7.0.0.
...
class Ipv6Address(VapiStruct):
    ...
    def __init__(self,
        ...
        """
        :type  ip_address: :class:`str`
        :param ip_address: Static IPv6 Address. This attribute was added in vSphere API 7.0.0.
        :type  prefix: :class:`long`
...
class Ipv6(VapiStruct):
    ...
    def __init__(self,
        ...
        :param ipv6: IPv6 address. This attribute was added in vSphere API 7.0.0.
            This attribute is optional and it is only relevant when the value
...
class IPSettings(VapiStruct):
    ...
    adapter. This class was added in vSphere API 7.0.0.
...
class CustomizationSpecs(VapiInterface):
    ...
    def get(self,
        ...
        specified identifier. This method was added in vSphere API 7.0.0.
