...
class PrecheckReport(VapiInterface):
    ...
    class Result(VapiStruct):
        ...
        def __init__(self,
            ...
            :param csv_report: The identifier of CSV formatted precheck report. null provides
                location where the CSV report can be downloaded from based on the
                ``csvReport``.
                When clients pass a value of this class as a parameter, the
                attribute must be an identifier for the resource type:
    ...
    def create_task(self,
        ...
        The result of this operation can be queried by calling the null method
        where ``task`` is the response of this operation.
