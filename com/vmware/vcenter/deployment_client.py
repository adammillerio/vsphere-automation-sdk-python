...
class DataMigrationInfo(VapiStruct):
    ...
    Server data. This class was added in vSphere API 7.0.0.
    ...
    def __init__(self,
        ...
        :param core_events_tasks: Migrate core, events, and tasks from vCenter Server. Stats will not
            be migrated. This attribute was added in vSphere API 7.0.0.
        ...
        :param core_events_tasks_with_deferred: Migrate core, events, and tasks from vCenter Server. Events and
            ...
            migrated. This attribute was added in vSphere API 7.0.0.
...
class SourceInfo(VapiStruct):
    """
    The ``SourceInfo`` {class contains the information about the source vCenter
    Server and the database migration options. This class was added in vSphere
    API 7.0.0.
...
class Migrate(VapiInterface):
    ...
    class VcsaEmbeddedSpec(VapiStruct):
        ...
        appliance. This class was added in vSphere API 7.0.0.
    ...
    class SourceVcWindows(VapiStruct):
        ...
        def __init__(self,
            ...
            :param hostname: The IP address or DNS resolvable name of the source Windows
                machine. This attribute was added in vSphere API 7.0.0.
            :type  username: :class:`str`
            :param username: The SSO account with administrative privilege to perform the
                migration operation. This attribute was added in vSphere API 7.0.0.
            :type  password: :class:`str`
    ...
    class MigrationAssistantSpec(VapiStruct):
        ...
        windows vCenter Server machine. This class was added in vSphere API 7.0.0.
    ...
    def get(self):
        ...
        migration. This method was added in vSphere API 7.0.0.
