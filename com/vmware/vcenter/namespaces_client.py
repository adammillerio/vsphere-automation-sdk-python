...
class Instances(VapiInterface):
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :param resource_spec: Quotas on the namespace resources. Refer to null for the type of
    ...
    class UpdateSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :type  resource_spec: :class:`vmware.vapi.struct.VapiStruct` or ``None``
            :param resource_spec: Resource quota updates on the namespace. Refer to null and use null
    ...
    class SetSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :param resource_spec: Resource quota for the namespace. This will replace the existing
                resource constraints on the namespace in entirety. Refer to null
                and use null for retrieving the type for the value for this field.
                For an example of this, see :class:`ResourceQuotaOptionsV1`.
    ...
    class CreateSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :type  resource_spec: :class:`vmware.vapi.struct.VapiStruct` or ``None``
            :param resource_spec: Resource quota on the namespace. Refer to null and use null for
                retrieving the type for the value for this field. For an example of
                this, see :class:`ResourceQuotaOptionsV1`.
