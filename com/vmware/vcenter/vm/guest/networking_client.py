...
class Interfaces(VapiInterface):
    ...
    class IpAddressStatus(Enum):
        ...
        operational. This class attribute was added in vSphere API 7.0.0.
        ...
        verified. This class attribute was added in vSphere API 7.0.0.
...
class Routes(VapiInterface):
    ...
    network routing information. This class was added in vSphere API 7.0.0.
    """
    ...
    def list(self,
        ...
        system. This method was added in vSphere API 7.0.0.
